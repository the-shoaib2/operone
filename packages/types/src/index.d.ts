...
export type ProviderType = 'openai' | 'anthropic' | 'ollama' | 'openrouter' | 'google' | 'mistral' | 'local' | 'custom';
...
export type ProviderConfig = OpenAIConfig | AnthropicConfig | OllamaConfig | OpenRouterConfig | GoogleConfig | MistralConfig | LocalConfig | CustomConfig;
